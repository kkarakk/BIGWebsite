    ...
    public void displayView(int viewId) {
        ...
        switch (viewId) {
            ...
            case R.id.group_content:
                ...
                break;
            case R.id.home_content:
                fragment= new HomecontentFragment();
                title= "Beyout Investment Group";
                break;
            case R.id.sectors_content:
                fragment= new SectorscontentFragment();
                title= "Sectors";
                break;
            case R.id.financial_content:
                fragment= new FinancialcontentFragment();
